...
UserService.signUpWithUsernameAndPassword = function _callee(username, password, emailAddress) {
  var user, result;
...
UserService.signInWithUsernameAndPassword = function _callee2(username, password) {
  var result;
  return regeneratorRuntime.async(
    function _callee2$(_context2) {
      while (1) {
        switch ((_context2.prev = _context2.next)) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap(_ParseWrapperService2.default.logIn(username, password));
          case 2:
...
UserService.sendEmailVerification = function _callee3() {
  var user;
  return regeneratorRuntime.async(
    function _callee3$(_context3) {
      while (1) {
        switch ((_context3.prev = _context3.next)) {
          case 0:
            _context3.next = 2;
            return regeneratorRuntime.awrap(_ParseWrapperService2.default.getCurrentUserAsync());
          case 2:
            user = _context3.sent;
...
UserService.resetPassword = function _callee4(emailAddress) {
  var user;
  return regeneratorRuntime.async(
...
UserService.updatePassword = function _callee5(newPassword) {
  var user;
  return regeneratorRuntime.async(
...
UserService.getCurrentUserInfo = function _callee6() {
  var user;
  return regeneratorRuntime.async(
...
UserService.getUserInfo = function _callee7(username) {
  var results;
  return regeneratorRuntime.async(
    function _callee7$(_context7) {
      while (1) {
        switch ((_context7.prev = _context7.next)) {
          case 0:
            _context7.next = 2;
            return regeneratorRuntime.awrap(_ParseWrapperService2.default.createUserQuery().equalTo('username', username).find());
          case 2:
